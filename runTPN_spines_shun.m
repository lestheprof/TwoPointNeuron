...
% basalinputs=[] ;
basalinputs = [0.51 1; 0.53 2];
% apicalinputs = [0.48 1];
apicalinputs = [];
apicalsynapseweights = [0.9 0.6];
basalsynapseweights =[1.0 0.9 1.1 0.98 1.1 1.3] ;
...
maxnospikes = 100 ;
    ...
    [aa,  ba, ahactiv, spikelist] =  TPN_spines_shun('duration',duration, 'timestep',timestep,  'noapicalinputs',n_apicalinputs, ...
